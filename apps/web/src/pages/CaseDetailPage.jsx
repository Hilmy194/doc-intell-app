  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        setUploadedFiles(filesRes.map((f) => ({ ...f, extractStatus: f.extractStatus || "pending" })));
      } catch (_) {/* non-fatal */}
    }
    load();
  }, [caseId]);
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                <span className="text-xs text-[#8b9cc8] truncate">
                  All Cases /
                </span>
              ...
              {caseInfo?.description && (
                <p className="text-sm text-[#8b9cc8] mt-0.5 truncate">{caseInfo.description}</p>
              )}
              {!caseInfo?.description && (
                <p className="text-sm text-[#8b9cc8] mt-0.5">Upload, parse, and extract structured data from your documents</p>
              )}
            </div>
          </div>
